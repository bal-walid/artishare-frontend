                ...
                <TableRow key={user.id}>
                  <TableCell>
                    <Avatar>
                      ...
                      <AvatarFallback>{user.first_name.slice(0, 1).toUpperCase() + user.last_name.slice(0, 1).toUpperCase()}</AvatarFallback>
                    </Avatar>
                  </TableCell>
                  <TableCell className="font-medium">{capitalize(user.first_name) + " " + capitalize(user.last_name)}</TableCell>
